...
Train a deep learning text classifier on a labelled dataset of *(activity label, NACE code)* pairs, using Insee's [torchTextClassifiers](https://github.com/InseeFrLab/torchTextClassifiers/) package. You will learn how to:
