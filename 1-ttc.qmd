...
Call `ttc.predict(np.array(example_texts), top_k=5, explain_with_captum=True)`. The result is a dictionary with keys `prediction`, `confidence` and `captum_attributions` among others. Inspect the content of the dictionary. Do you understand what it contains?
